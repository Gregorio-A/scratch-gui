...
const MENU_ADVANCED = 'advancedMenu';
...
const rootMenu = new Menu('root')
    ...
    .addChild(new Menu(MENU_ADVANCED))
...
const openAdvancedMenu = () => openMenu(MENU_ADVANCED);
const closeAdvancedMenu = () => closeMenu(MENU_ADVANCED);
const advancedMenuOpen = state => state.scratchGui.menus[MENU_ADVANCED];
